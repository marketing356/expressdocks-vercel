...
export const metadata: Metadata = {
  title: 'Become an ExpressDocks Dealer | ExpressDocks',
  description: 'Join our dealer network and offer your customers the best factory-direct aluminum dock systems in the industry. Competitive margins, full support, and exclusive territories.',
}
...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">Become an ExpressDocks Dealer</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">Join our dealer network and offer your customers the best factory-direct aluminum dock systems in the industry. Competitive margins, full support, and exclusive territories.</p>
