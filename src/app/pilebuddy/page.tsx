...
export const metadata: Metadata = {
  ...
  description: 'PileBuddy is a smarter mooring solution for marinas that use pile slips. Simplify docking, reduce wear, and improve the experience for every boat owner in your marina.',
}
...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">PileBuddy Mooring System</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">PileBuddy is a smarter mooring solution for marinas that use pile slips. Simplify docking, reduce wear, and improve the experience for every boat owner in your marina.</p>
