...
export const metadata: Metadata = {
  title: 'Cement Dock Systems | ExpressDocks',
  description: 'Durable cement dock foundations and hybrid dock systems for permanent waterfront installations.',
}

export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6" style={{ background: '#0E1433', color: '#EEF1FA', minHeight: '100vh' }}>
      <h1 className="text-4xl font-bold text-center mb-6">Cement Dock Systems</h1>
      <p className="text-xl text-center mb-10 leading-relaxed" style={{ color: '#8A95C9' }}>
        Permanent cement dock foundations and hybrid systems for demanding waterfront applications.
      </p>
      ...
      <div className="rounded-xl p-8 mb-10" style={{ background: '#151B3D', border: '1px solid rgba(138,149,201,0.2)' }}>
        ...
        <p className="mb-6" style={{ color: '#8A95C9' }}>Tell us about your waterfront project and we'll provide a custom quote.</p>
