...
export const metadata: Metadata = {
  title: 'About ExpressDocks | ExpressDocks',
  description: 'ExpressDocks has been manufacturing and shipping premium aluminum dock systems since 2012. Factory-direct from our 30,000 sqft facility in Middletown, Delaware.',
}
...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">About ExpressDocks</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">ExpressDocks has been manufacturing and shipping premium aluminum dock systems since 2012. Factory-direct from our 30,000 sqft facility in Middletown, Delaware.</p>
