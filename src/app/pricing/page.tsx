...
export const metadata: Metadata = {
  title: 'Dock Pricing | ExpressDocks',
  description: 'Transparent factory-direct pricing with no hidden fees. Residential from $60/sqft, commercial from $75/sqft, fingers & gangways from $85/sqft.',
}
...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">Dock Pricing</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">Transparent factory-direct pricing with no hidden fees. Residential from $60/sqft, commercial from $75/sqft, fingers & gangways from $85/sqft.</p>
