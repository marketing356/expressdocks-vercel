...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">Residential Floating Docks</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">Premium aluminum floating dock systems for homeowners. Starting at $60/sqft with a 50-year guarantee. Factory-direct, ships to your waterfront.</p>
