        ...
        <div className="mb-16">
          ...
          <div className="space-y-4">
            {[
              ...
              { q: 'How do I know what size to order?', a: 'Send us a quick sketch of your waterfront — or just a photo and a rough description. Our team designs a custom layout for you within 48 hours, completely free, with no obligation to buy. We\'ll spec the right size based on your shoreline shape, water depth, boat size, and how you plan to use it. Most customers are surprised how personalized the process is for a factory-direct product.' },
            ].map((item, i) => (
