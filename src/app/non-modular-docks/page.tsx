...
export default function Page() {
  return (
    <main className="max-w-4xl mx-auto py-16 px-6">
      ...
      <h1 className="text-4xl font-bold text-[#0a1628] mb-6">Non-Modular Dock Systems</h1>
      <p className="text-xl text-gray-600 mb-10 leading-relaxed">Custom-engineered aluminum dock systems built to your exact specifications. Ideal for permanent installations with specific structural requirements.</p>
