    ...
    <main style={{ background: '#0E1433', color: '#EEF1FA' }}>
      <section className="relative py-32 px-6 text-center" style={{
        ...
        <p className="text-xl mb-4 max-w-2xl mx-auto" style={{ color: 'rgba(238,241,250,0.85)' }}>
          No Heavy Equipment Required. Durable, low-maintenance commercial dock systems for marinas, resorts, municipalities, and waterfront developments nationwide. Starting at <strong>$75/sqft</strong>.
        </p>
